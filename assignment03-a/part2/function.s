#####################################
#As far as we know, this code works.
#Create the executable by running:
#gcc -g -c function.s && ld function.o -o function
#Note: Does not support bad values. In particular,
#if your first input is anything other than 1 or 2, it will subtract.
#The input values for the two numbers to operate on must be only
#digits (0-9).
#####################################
...
#We return to the previous section using ret.
