...
For this lab I recommend working from your virtual box or vagrant image. It will make viewing the image we are generating a little bit easier. Otherwise, you may (as always) work through ssh, and I will provide a few solutions for how to view images when ssh'd into the servers.
...
For part one you will be working in the [vfork.c](./vfork.c) file. Our artists prefer to paint in Unix, so again I recommend you work from your virtual box/vagrant installation. 
...
- Run:  `cat /proc/cpuinfo | grep "cpu cores"` 
  ...
  - (The last time I checked there are 12 cpu cores available on 40+ machines. It may be convenient for us to work in multiples of 8 (a nice power of 2 < 12), which we can always increase later).
  
**Discuss with your neighbor/classmate:** (And write 1 sentence about your findings here)

*There are 12 cpu cores available.*
...
**Discuss with your neighbor/classmate:** (And write 1 sentence about where you think we are forgetting to reclaim memory)
...
**Discuss with your neighbor/classmate:** (And write 1 sentence about the difference between fork and vfork)
...
- Use vfork to launch 64 processes in your loop.
  - (Note that you could potentially launch more for a bigger color array--but your machine may have a [soft limit](https://www.ibm.com/support/knowledgecenter/en/SSCRJU_4.0.1/com.ibm.streams.install.doc/doc/ibminfospherestreams-install-operating-system-settings.html) of 100 or so processes per user).
  	- Run `ulimit -u` to see the limit of processes you have. Mine is 4096 for the server machines (yours may be greater or less, and potentially unlimited if you are on your Virtual Machine).
...
**Discuss with your neighbor/classmate:** (And write 1 sentence if you think you need to use locks anywhere in this solution)
